function [shapeFile] = bw_FSLmesh2shape(meshFile, matFile, filePrefix, dims)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
% bug fix for version 4.2 - needed to replace hard-coded 256 MR dimensions with passed
% dimensions since .nii files can be arbitary
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %
    vertices(:,1) = (dims(1)-1) - vertices(:,1);
    ...
    na(2) = dims(2) - na(2); le(2) = dims(2) - le(2); re(2) = dims(2) - re(2);
    na(3) = dims(3) - na(3); le(3) = dims(3) - le(3); re(3) = dims(3) - re(3);
