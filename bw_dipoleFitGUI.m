...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    plotbox = [0.05 0.64 0.54 0.32];
    mapbox = [0.63 0.58 0.35 0.35];
    dipMapbox = [0.63 0.1 0.35 0.35];
    dipPlotbox = [0.45 0.22 0.18 0.22];
    ...
    fh = figure('Position',[scrnsizes(1,3)/3+200 scrnsizes(1,4)/2 1200 800],'color','white','menubar','none',...
        'numberTitle','off','WindowButtonUpFcn',@stopdrag,'WindowButtonDownFcn',@buttondown,...
        'keypressfcn',@capturekeystroke,'CloseRequestFcn',@quit_callback);
    ...
    channel_dropdown = uicontrol('style','popup','units','normalized',...
        ...
        'Backgroundcolor','white','fontsize',9,'value',1,'callback',...
   ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    latency_text = uicontrol('style','text','units','normalized','position',[0.05 0.54 0.1 0.03],...
            'string',s,'fontsize',9,'backgroundcolor',BACKCOLOR,'horizontalalignment','left');

    uicontrol('style','pushbutton','units','normalized','position',[0.15 0.545 0.03 0.03],...
            'CData',leftarrow_im,'Foregroundcolor','black','backgroundcolor','white','fontsize',9,'callback',@cursor_left_callback);                         
    ...
    uicontrol('style','pushbutton','units','normalized','position',[0.19 0.545 0.03 0.03],...
            'CData',rightarrow_im,'Foregroundcolor','black','backgroundcolor','white','fontsize',9,'callback',@cursor_right_callback);                    
    ...
    trial_text = uicontrol('style','text','units','normalized','position',[0.07 0.66 0.08 0.02],...
            'string','Average','fontsize',9,'backgroundcolor',BACKCOLOR,'horizontalalignment','left');
 
    trialDecArrow = uicontrol('style','pushbutton','units','normalized','enable','off','position',[0.6 0.64 0.05 0.03],...
            'string','Trial -','Foregroundcolor','black','backgroundcolor','white','fontsize',9,'callback',@trialDec_callback);
    trialIncArrow = uicontrol('style','pushbutton','units','normalized','enable','off','position',[0.6 0.7 0.05 0.03],...
            'string','Trial +','Foregroundcolor','black','backgroundcolor','white','fontsize',9,'callback',@trialInc_callback);     
    ...
    uicontrol('style','pushbutton','units','normalized','fontsize',9,'position',[0.6 0.91 0.03 0.04],...
    'CData',uparrow_im,'Foregroundcolor','black','backgroundcolor','white','callback',@scaleUp_callback);

    uicontrol('style','pushbutton','units','normalized','fontsize',9,'position',[0.6 0.86 0.03 0.04],...
    ...
    uicontrol('style','pushbutton','units','normalized','fontsize',9,'position',[0.6 0.8 0.06 0.04],...
    ...
    uicontrol('style','pushbutton','units','normalized','fontsize',9,'position',[0.6 0.75 0.06 0.04],...
    ...
    uicontrol('style','text','units','normalized','position',[0.24 0.53 0.14 0.04],...
        'string','Filter (Hz):','fontsize',9,'backgroundcolor',BACKCOLOR,'horizontalalignment','left');
    uicontrol('style','edit','units','normalized','position',[0.30 0.545 0.03 0.03],...
        'FontSize', 9,'BackGroundColor','white','string',highPass,'callback',@filter_hipass_callback);  
    ...
    uicontrol('style','text','units','normalized','position',[0.34 0.53 0.12 0.04],...
        'string','to','fontsize',9,'backgroundcolor',BACKCOLOR,'horizontalalignment','left');
    uicontrol('style','edit','units','normalized','position',[0.36 0.545 0.03 0.03],...
        'FontSize', 9, 'BackGroundColor','white','string',lowPass,'callback',@filter_lowpass_callback);       
    ...
    uicontrol('style','checkbox','units','normalized','position',[0.41 0.54 0.18 0.04],'value',useBaseline,...
            'string','Apply Baseline','Foregroundcolor','black','backgroundcolor',BACKCOLOR,'fontsize',9,'callback',@baseline_callback);
    ...
    base_start=uicontrol('style','edit','units','normalized','position',[0.5 0.545 0.03 0.03],...
        'FontSize', 9, 'BackGroundColor','white','string',baselineStart,'callback',@baseStart_callback);        
    ...
    base_start_txt=uicontrol('style','text','units','normalized','position',[0.54 0.53 0.12 0.04],...
        'string','to','fontsize',9,'backgroundcolor',BACKCOLOR,'horizontalalignment','left');
    
    base_end=uicontrol('style','edit','units','normalized','position',[0.56 0.545 0.03 0.03],...
        'FontSize', 9, 'BackGroundColor','white','string',baselineEnd,'callback',@baseEnd_callback);
        function baseEnd_callback(src,~)
            baselineEnd=str2double(get(src,'string'));
            updatePlot;
            drawMap(latency);
        end
    base_end_txt=uicontrol('style','text','units','normalized','position',[0.6 0.53 0.12 0.04],...
        'string','seconds','fontsize',9,'backgroundcolor',BACKCOLOR,'horizontalalignment','left');
    ...
    function plot_average
        ...
        set(axtest,'ylim',[minScale maxScale],'xlim',[minRange maxRange],'FontSize',9);
        ...
        ylabel('femtoTesla','FontSize',9);        
        tt = title(dsName);
        set(tt,'fontsize',9,'Interpreter','none');
    ...
    function plot_GFP
        ...
        axtest = subplot('Position', plotbox);      
        plot(timeVec, rms);
        set(axtest,'ylim',[0 maxScale],'xlim',[minRange maxRange],'fontsize',9);
        ...
        xlabel('Time (sec)','FontSize',9);
        ylabel('femtoTesla (RMS)','FontSize',9);
    ...
    dip_text(16) = uicontrol('style','text','units','normalized','backgroundcolor','white','position',[0.2 0.395 0.08 0.03],...
            'string','Source Model:','fontsize',9,'horizontalalignment','left', 'enable','off');    
        
        
    fit_text = uicontrol('style','text','units','normalized','backgroundcolor','white','position',[0.42 0.45 0.15 0.03],...
            'string','Fit Error = 0.0','fontsize',10,'fontweight','bold','horizontalalignment','left', 'enable','off');  
    fitting_txt = uicontrol('style','text','units','normalized','backgroundcolor','white','position',[0.52 0.45 0.12 0.03],...
            'string','','fontsize',10,'foregroundColor','red','horizontalalignment','left', 'enable','off');  
       
    xedit = uicontrol('style','edit','units','normalized','backgroundcolor','white','position',[0.1 0.4 0.08 0.03],...
            'string',startPos(1,currentDip),'fontsize',9,'horizontalalignment','left', 'enable','off','callback',@updateParams_callback);
    yedit = uicontrol('style','edit','units','normalized','backgroundcolor','white','position',[0.1 0.36 0.08 0.03],...
            'string',startPos(2,currentDip),'fontsize',9,'horizontalalignment','left', 'enable','off','callback',@updateParams_callback);
    zedit = uicontrol('style','edit','units','normalized','backgroundcolor','white','position',[0.1 0.32 0.08 0.03],...
            'string',startPos(3,currentDip),'fontsize',9,'horizontalalignment','left', 'enable','off','callback',@updateParams_callback);
 
    xoedit = uicontrol('style','edit','units','normalized','backgroundcolor','white','position',[0.1 0.245 0.08 0.03],...
            'string',startOri(1,currentDip),'fontsize',9,'horizontalalignment','left', 'enable','off','callback',@updateParams_callback);
    yoedit = uicontrol('style','edit','units','normalized','backgroundcolor','white','position',[0.1 0.205 0.08 0.03],...
            'string',startOri(2,currentDip),'fontsize',9,'horizontalalignment','left', 'enable','off','callback',@updateParams_callback);
    zoedit = uicontrol('style','edit','units','normalized','backgroundcolor','white','position',[0.1 0.165 0.08 0.03],...
            'string',startOri(3,currentDip),'fontsize',9,'horizontalalignment','left', 'enable','off','callback',@updateParams_callback);

    sphereX = uicontrol('style','edit','units','normalized','backgroundcolor','white','position',[0.24 0.245 0.04 0.03],...
            'string',sphere(1),'fontsize',9,'horizontalalignment','left', 'enable','off','callback',@fitDipole_callback);
    sphereY = uicontrol('style','edit','units','normalized','backgroundcolor','white','position',[0.24 0.205 0.04 0.03],...
            'string',sphere(2),'fontsize',9,'horizontalalignment','left', 'enable','off','callback',@fitDipole_callback);
    sphereZ = uicontrol('style','edit','units','normalized','backgroundcolor','white','position',[0.24 0.165 0.04 0.03],...
            'string',sphere(3),'fontsize',9,'horizontalalignment','left', 'enable','off','callback',@fitDipole_callback);    
        
    momentEdit = uicontrol('style','edit','units','normalized','backgroundcolor','white','position',[0.1 0.12 0.08 0.03],...
            'string',moments(1),'fontsize',9,'horizontalalignment','left', 'enable','off');        
        
        
    passesEdit = uicontrol('style','edit','units','normalized','backgroundcolor','white','position',[0.28 0.365 0.04 0.03],...
            'string',numPasses,'fontsize',9,'horizontalalignment','left', 'enable','off');
    toleranceEdit = uicontrol('style','edit','units','normalized','backgroundcolor','white','position',[0.28 0.325 0.04 0.03],...
            'string',tolerance,'fontsize',9,'horizontalalignment','left', 'enable','off');    
            
    dipole_menu = uicontrol('style','popup','units','normalized','fontsize',9,'position',[0.04 0.45 0.08 0.03],...
        'Foregroundcolor','black','string', {'Dipole 1'},'enable','off','backgroundcolor','white','callback',@dipoleMenu_callback);   
   
    constraint_menu = uicontrol('style','popup','units','normalized','fontsize',9,'position',[0.125 0.45 0.1 0.03],'value',1,...
    ...
    add_dipole_button = uicontrol('style','pushbutton','units','normalized','fontsize',9,'position',[0.24 0.455 0.06 0.025],...
        'Foregroundcolor','black','string','Add Dipole','enable','off','backgroundcolor','white','callback',@addDipole_callback);   

    remove_dipole_button = uicontrol('style','pushbutton','units','normalized','fontsize',9,'position',[0.31 0.455 0.07 0.025],...
        'Foregroundcolor','black','string','Delete Dipole','enable','off','backgroundcolor','white','callback',@removeDipole_callback);   

    
    dipoleType_menu = uicontrol('style','popup','units','normalized','fontsize',9,'position',[0.27 0.4 0.12 0.03],'value',dipoleType,...
    ...
    fitDipole_button = uicontrol('style','pushbutton','units','normalized','fontsize',9,'position',[0.05 0.05 0.08 0.035],...
        'Foregroundcolor','blue','string','Fit Dipole','enable','off','backgroundcolor','white','callback',@fitDipole_callback);
       
    reset_button = uicontrol('style','pushbutton','units','normalized','fontsize',9,'position',[0.15 0.05 0.1 0.035],...
        'Foregroundcolor','blue','string','Reset Parameters','enable','off','backgroundcolor','white','callback',@resetParams_callback);
 
    headModel_button = uicontrol('style','pushbutton','units','normalized','fontsize',9,'position',[0.2 0.125 0.1 0.03],...
        'Foregroundcolor','black','string','Read Head Model','enable','off','backgroundcolor','white','callback',@headModel_callback);
    
    plotDipoleButton = uicontrol('style','pushbutton','units','normalized','fontsize',9,'position',[0.37 0.05 0.1 0.035],...
        'Foregroundcolor','black','string','Overlay on MRI','enable','off','backgroundcolor','white','callback',@plotDipole_callback);
    
    saveDipoleButton = uicontrol('style','pushbutton','units','normalized','fontsize',9,'position',[0.48 0.05 0.08 0.035],...
    ...
    function origin = readHeadModelFile(file)
        ...
        if iscell(t)
            ...
            idx = find(tab(:,1) == 'M');
            if isempty(idx)
                % check for FieldLine names
                idx = find(tab(:,1) == 'L');
            end
            if isempty(idx)
                errordlg('Cannot find sensor names in .hdm file ...');
                origins = [];
                return;
            end
            origins = t.data(idx,:);  
    ...
    MapScale_button = uicontrol('style','pushbutton','units','normalized','fontsize',9,'position',[0.9 0.535 0.06 0.0],...
    ...
    uicontrol('style','checkbox','units','normalized','fontsize',9,'value',autoscaleMap,'position',[0.76 0.56 0.08 0.04],...
    ...
    uicontrol('style','checkbox','units','normalized','fontsize',9,'value',showSensorLabels,'position',[0.76 0.53 0.08 0.04],...
    ...
    function drawMap(latency)
        ...
        tt = title(tstr);
        set(tt,'Interpreter','none','fontsize',10,'fontweight','bold');
