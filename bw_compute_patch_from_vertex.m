%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% function [patch_vertices, nfaces, area] = bw_compute_patch_from_vertex(mesh, seed_vertex, patchOrder)
%
...
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [patch_vertices, patch_faces, total_area] = bw_compute_patch_from_vertex(mesh, seed_vertex, patchOrder)
