...
% initialize parameters before opening window (new version) 
params = bw_checkPrefs;

IMAGE_TYPE = params.beamformer_parameters.imageType;
...
uicontrol('style','text','fontSize',10,'units','normalized','position',...
    [0.03 0.965 0.08 0.025],'string','Data Selection','BackgroundColor','white','foregroundcolor','blue','fontweight','b');
...
WORKSPACE_TEXT_TITLE = uicontrol('Style','Text','Units','Normalized','Position',...
        [0.05 0.9 0.35 0.06],'String','Data Directory:','HorizontalAlignment','left',...
        'BackgroundColor','White', 'enable','off');
    
DS_LISTBOX=uicontrol('Style','Listbox','enable','off','fontSize',8,'Units','Normalized','Position',...
    [0.05 0.75 0.3 0.15],'String',ds_filename,'HorizontalAlignment','Center','BackgroundColor',...
    'White','Callback',@DS_LISTBOX_CALLBACK);

COV_DS_LISTBOX=uicontrol('Style','Listbox','enable','off','fontSize',8,'Units','Normalized','Position',...
    [0.05 0.56 0.3 0.15],'String',ds_filename,'HorizontalAlignment','Center','BackgroundColor',...
    'White','Callback',@COV_DS_LISTBOX_CALLBACK);

SET_WORKSPACE_BUTTON = uicontrol('Style','PushButton','enable','on','FontSize',9,'Units','Normalized','Position',...
    [0.049 0.91 0.06 0.025],'String','Change Dir','HorizontalAlignment','Left',...
    'foregroundcolor','blue','Callback',@WORKSPACE_BUTTON_CALLBACK);

REFRESH_DS_BUTTON = uicontrol('Style','PushButton','enable','on','FontSize',9,'Units','Normalized','Position',...
    [0.12 0.91 0.05 0.025],'String','Refresh','HorizontalAlignment','Left',...
    'foregroundcolor','blue','Callback',@REFRESH_DS_CALLBACK);

COMBINE_DS_BUTTON = uicontrol('Style','PushButton','enable','on','FontSize',9,'Units','Normalized','Position',...
    [0.18 0.91 0.12 0.025],'String','Combine Datasets','HorizontalAlignment','Left',...
...
DATASET_TEXT_TITLE = uicontrol('style','text','Units','Normalized','Position',...
    [0.37 0.85 0.24 0.06],'String',ds_title,'BackgroundColor','White','HorizontalAlignment','left');

DATASET_INFO_TEXT=uicontrol('style','text','Units','Normalized','Position',...
    [0.37 0.7 0.24 0.12],'String',ds_info,'BackgroundColor','White','HorizontalAlignment','left');

PLOT_DATA_BUTTON=uicontrol('Style','PushButton','FontSize',9,'Units','Normalized','Position',...
    [0.5 0.6 0.1 0.03], 'String','Plot Data','HorizontalAlignment','Center',...
    'ForegroundColor','blue','Callback',@PLOT_DATA_BUTTON_CALLBACK);

% generate buttons 
PLOT_BEAMFORMER_BUTTON=uicontrol('Style','PushButton','fontSize',10,'Units','Normalized','Position',...
...
LATENCY_EDIT_BUTTON=uicontrol('Style','PushButton','FontSize',9,'Units','Normalized','ForegroundColor','blue','Position',...
...
% ERB controls
uicontrol('style','text','fontSize',10,'units','normalized','position',...
    [0.03 0.51 0.08 0.02],'string','Time Windows','BackgroundColor','white','foregroundcolor','blue','fontweight','b');
...
LATENCY_LIST=uicontrol('Style','edit','FontSize',9,'Units','Normalized','Min',1,'Max',10000,'enable','off','Position',...
...
PLOT_BEAMFORMER_START_LAT_EDIT=uicontrol('Style','Edit','FontSize',9,'Units','Normalized','Position',...
    [0.2 0.445 0.05 0.035],'String',params.beamformer_parameters.beam.latencyStart,'BackgroundColor','White','Callback',...
    @PLOT_BEAMFORMER_START_LAT_EDIT_CALLBACK);
PLOT_BEAMFORMER_END_LAT_EDIT=uicontrol('Style','Edit','FontSize',9,'Units','Normalized','Position',...
    [0.3 0.445 0.05 0.035],'String',params.beamformer_parameters.beam.latencyEnd,'BackgroundColor','White','Callback',...
    @PLOT_BEAMFORMER_END_LAT_EDIT_CALLBACK);
PLOT_BEAMFORMER_STEP_LAT_EDIT=uicontrol('Style','Edit','FontSize',9,'Units','Normalized','Position',...
    [0.4 0.445 0.05 0.035],'String',params.beamformer_parameters.beam.step,'BackgroundColor',...
    'White','Callback',@PLOT_BEAMFORMER_STEP_LAT_EDIT_CALLBACK);

COV_DS_CHECK=uicontrol('Style','checkbox','fontSize',10,'Units','Normalized','Position',...
...
MULTI_DS_SAM_CHECK=uicontrol('Style','checkbox','fontSize',10,'Units','Normalized','Position',...
...
RADIO_Z=uicontrol('style','radiobutton','units','normalized','position',[0.07 0.37 0.1 0.03],...
    'string','Pseudo-Z','backgroundcolor','white','value',0,'fontSize',10,'callback',@RADIO_Z_CALLBACK);
RADIO_T=uicontrol('style','radiobutton','units','normalized','position',[0.07 0.33 0.1 0.03],...
    'string','Pseudo-T','backgroundcolor','white','value',0,'fontSize',10,'callback',@RADIO_T_CALLBACK);
RADIO_F=uicontrol('style','radiobutton','units','normalized','position',[0.07 0.29 0.1 0.03],...
    'string','Pseudo-F','backgroundcolor','white','value',0,'fontSize',10,'callback',@RADIO_F_CALLBACK);
...
ACTIVE_START_LABEL=uicontrol('Style','Text','fontSize',9,'Units','Normalized','HorizontalAlignment','Left','Position',...
    [0.17 0.37 0.05 0.02],'String','Start:','BackgroundColor','White');
ACTIVE_END_LABEL=uicontrol('Style','Text','fontSize',9,'Units','Normalized','HorizontalAlignment','Left','Position',...
    [0.27 0.37 0.04 0.02],'String','End:','BackgroundColor','White');
ACTIVE_STEPSIZE_LABEL=uicontrol('Style','Text','fontSize',9,'Units','Normalized','HorizontalAlignment','Left','Position',...
    [0.37 0.37 0.08 0.02],'String','Step Size:','BackgroundColor','White');
ACTIVE_NO_STEP_LABEL=uicontrol('style','text','fontSize',9,'units','normalized','HorizontalAlignment','Left','position',...
    [0.48 0.37 0.08 0.02],'string','No. Steps:','backgroundcolor','white');


ACTIVE_START_EDIT=uicontrol('Style','Edit','fontSize',9,'Units','Normalized','Position',...
    [0.2 0.36 0.05 0.035],'String',params.beamformer_parameters.beam.activeStart,'BackgroundColor','White','Callback',@ACTIVE_START_EDIT_CALLBACK);
ACTIVE_END_EDIT=uicontrol('Style','Edit','fontSize',9,'Units','Normalized','Position',...
    [0.3 0.36 0.05 0.035],'String',params.beamformer_parameters.beam.activeEnd,'BackgroundColor','White','Callback',@ACTIVE_END_EDIT_CALLBACK);
ACTIVE_STEP_LAT_EDIT=uicontrol('Style','Edit','fontSize',9,'Units','Normalized','Position',...
    [0.42 0.36 0.05 0.035],'String',params.beamformer_parameters.beam.active_step,'BackgroundColor',...
    'White','Callback',@ACTIVE_STEP_LAT_EDIT_CALLBACK);
ACTIVE_NO_STEP_EDIT=uicontrol('style','edit','fontSize',9,'units','normalized','position',...
    [0.53 0.36 0.05 0.035],'string',params.beamformer_parameters.beam.no_step,'Backgroundcolor','white','callback',@ACTIVE_NO_STEP_EDIT_CALLBACK);

BASELINE_WINDOW_LABEL = uicontrol('Style','Text','fontSize',9,'Units','Normalized','Position',...
    [0.17 0.31 0.18 0.025],'String','Baseline Window (s):','Background','White','HorizontalAlignment','Left');
BASELINE_START_LABEL=uicontrol('Style','Text','fontSize',9,'Units','Normalized','HorizontalAlignment','Left','Position',...
    [0.17 0.28 0.05 0.02],'String','Start:','BackgroundColor','White');
BASELINE_END_LABEL=uicontrol('Style','Text','fontSize',9,'Units','Normalized','HorizontalAlignment','Left','Position',...
    [0.27 0.28 0.04 0.02],'String','End:','BackgroundColor','White');

BASELINE_START_EDIT=uicontrol('Style','Edit','fontSize',9,'Units','Normalized','Position',...
    [0.2 0.27 0.05 0.035],'String',params.beamformer_parameters.beam.baselineStart,'BackgroundColor',...
    'White','Callback',@BASELINE_START_EDIT_CALLBACK);
BASELINE_END_EDIT=uicontrol('Style','Edit','fontSize',9,'Units','Normalized','Position',...
    [0.3 0.27 0.05 0.035],'String',params.beamformer_parameters.beam.baselineEnd,'BackgroundColor',...
    'White','Callback',@BASELINE_END_EDIT_CALLBACK);

% Image type fields

uicontrol('style','text','fontSize',10,'units','normalized','position',...
    [0.03 0.21 0.08 0.02],'string','Image Type','BackgroundColor','white','foregroundcolor','blue','fontweight','b');
...
VOLUME_RADIO=uicontrol('Style','radiobutton','FontSize',10,'Units','Normalized','Position',...
    ...
    'BackgroundColor','White','Callback',@VOLUME_RADIO_CALLBACK);
...
MEG_RADIO=uicontrol('Style','radiobutton','FontSize',10,'Units','Normalized','Position',...
    ...
    'BackgroundColor','White','value',0,'Callback',@MEG_RADIO_CALLBACK);
...
SPM_RADIO=uicontrol('Style','radiobutton','FontSize',10,'Units','Normalized','Position',...
    ...
    'BackgroundColor','White','value',1,'Callback',@SPM_RADIO_CALLBACK);
...
SURFACE_RADIO=uicontrol('Style','radiobutton','FontSize',10,'Units','Normalized','Position',...
    ...
    'BackgroundColor','White','value',0,'Callback',@SURFACE_RADIO_CALLBACK);
  
SURFACE_FILE_EDIT=uicontrol('style','edit','units','normalized','position', [0.13 0.05 0.15 0.04],...
        'String', params.beamformer_parameters.surfaceFile, 'FontSize', 9, 'BackGroundColor','white');

SURFACE_MENU = uicontrol('style','popup','units','normalized','position', [0.3 0.04 0.1 0.04],...
        'string','none','FontSize', 9,'callback',@surface_menu_callback);

SURFACE_FILE_BUTTON=uicontrol('style','pushbutton','units','normalized','position', [0.41 0.05 0.1 0.04],...
        'string', 'Load Surface...', 'FontSize', 9,'ForeGroundColor','blue','callback',@surface_file_button_callback);

    
IMAGE_OPTIONS_BUTTON=uicontrol('Style','PushButton','FontSize',9,'Units','Normalized','Position',...
...
if IMAGE_TYPE == 0
    ...
    set(VOLUME_RADIO,'value',1);
end

if IMAGE_TYPE == 3
    set(SPM_RADIO, 'value',1);  
...
BASELINE_SET_FULL_BUTTON=uicontrol('style','checkbox','units','normalized','position', [0.85 0.7 0.1 0.035],...
...
%%%%%%%%%%%%%%%%%%%%%%%% 
    ...
    %%%%% create beamformer images %%%%

    function PLOT_BEAMFORMER_BUTTON_CALLBACK(~,~)


        % make sure we have updated values from GUI edit fields
        ...
        % check options and create input file paths ....
        if useCovDs 
        ...
        if (params.beamformer_parameters.covWindow(1) < covDsParams.epochMinTime || params.beamformer_parameters.covWindow(2) > covDsParams.epochMaxTime)
            s = sprintf('Covariance window (%.3f to %.3f seconds) exceeds data range (%.3f to %.3f seconds)\n',....
                params.beamformer_parameters.covWindow, dsParams.epochMinTime, covDsParams.epochMaxTime);
            beep;
            errordlg(s)
            return;
        end
        ...
        [~, cov_ds_name, ~, mri_dir, mri_filename] = bw_parse_ds_filename(covDsName);

        
        % pre-processing, if necessary create voxFiles...

        if IMAGE_TYPE == 0
            % *********************************
            % surface based image - create voxfile from mesh 
            if isempty(meshFile) 
        ...
        elseif IMAGE_TYPE == 3 
            ...
            if ~exist(tfile)
                errordlg('Could not find transform file %s. You may need to import Freesurfer surfaces ...', tfile)
            end
            ...
            analysisPath = sprintf('%s%sANALYSIS',full_ds_filename, filesep);
        ...
        % ************************ ************************
        % now create beamformer images as text files or .svl files
        ...
        if IMAGE_TYPE == 0
            % all done..
            % for surfaces display with surface viewer.
            bw_meshViewer(meshFile, imageList);

        elseif IMAGE_TYPE == 1
            % just use the created .svl files 
        ...
        elseif IMAGE_TYPE == 3
            ...
            % now convert *.txt image files to MNI volumes 
        ...
        % for volumes create "imagesets" and open in MIP plot
        % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        if IMAGE_TYPE > 0 
            % Save image
    ...
    function MEG_RADIO_CALLBACK(~,~)
        setImageType(1);
    end

    function SPM_RADIO_CALLBACK(~,~)
        setImageType(3);
    end
