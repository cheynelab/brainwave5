%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  Write a new .res4 file.  Use ieee-be (big endian) format
...
%   
%   Nov 2025 - modified from yokagawa_writeRes4.m  - MAX_COILS set to
%   default of 8 (not sure why)
%  
%   D. Cheyne, November, 2025
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function err = bw_writeRes4(res4File,res4)
