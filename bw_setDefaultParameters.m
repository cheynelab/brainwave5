...
function [params] = bw_setDefaultParameters(dsName)
    ...
    params.beamformer_parameters.outputFormat=0;      
    params.beamformer_parameters.imageType = 3;       % new in version 5.0 for GUI options ( 0 = surface, 1 = .svl, 3 = MNI (.nii) )  - overrides useVoxFile flag
